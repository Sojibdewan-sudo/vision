  ...
  return (
    <div className="max-w-3xl mx-auto py-16 px-4 sm:px-6 lg:px-8 animate-in fade-in duration-500">
      ...
      <div className="prose dark:prose-invert text-slate-600 dark:text-slate-300 space-y-4">
        <p>Welcome to Vision AI Tools, your all-in-one platform for precise calculations, comprehensive unit conversions, and intelligent problem-solving.</p>
...
export function TermsConditions() {
  return (
    <div className="max-w-3xl mx-auto py-16 px-4 sm:px-6 lg:px-8 animate-in fade-in duration-500">
      ...
      <div className="prose dark:prose-invert text-slate-600 dark:text-slate-300 space-y-4">
        <p>By accessing and using Vision AI Tools, you accept and agree to be bound by the terms and provision of this agreement.</p>
...
export function PrivacyPolicy() {
  return (
    <div className="max-w-3xl mx-auto py-16 px-4 sm:px-6 lg:px-8 animate-in fade-in duration-500">
      ...
      <div className="prose dark:prose-invert text-slate-600 dark:text-slate-300 space-y-4">
        <p>Your privacy is important to us. This policy explains how we handle your data when you use Vision AI Tools.</p>
